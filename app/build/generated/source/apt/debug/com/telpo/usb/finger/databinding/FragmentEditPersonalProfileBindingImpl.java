...
public class FragmentEditPersonalProfileBindingImpl extends FragmentEditPersonalProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.surname_layout, 20);
        sViewsWithIds.put(R.id.othername_layout, 21);
        sViewsWithIds.put(R.id.nationality_layout, 22);
        sViewsWithIds.put(R.id.gender_layout, 23);
        sViewsWithIds.put(R.id.bdate_layout, 24);
        sViewsWithIds.put(R.id.age_layout, 25);
        sViewsWithIds.put(R.id.bplace_layout, 26);
        sViewsWithIds.put(R.id.hometown_layout, 27);
        sViewsWithIds.put(R.id.farmcomm_layout, 28);
        sViewsWithIds.put(R.id.region_layout, 29);
        sViewsWithIds.put(R.id.district_layout, 30);
        sViewsWithIds.put(R.id.residential_layout, 31);
        sViewsWithIds.put(R.id.telephone_layout, 32);
        sViewsWithIds.put(R.id.maritalstat_layout, 33);
        sViewsWithIds.put(R.id.email_layout, 34);
        sViewsWithIds.put(R.id.edu_layout, 35);
        sViewsWithIds.put(R.id.post_layout, 36);
        sViewsWithIds.put(R.id.idtype_layout, 37);
        sViewsWithIds.put(R.id.idnum_layout, 38);
        sViewsWithIds.put(R.id.cancel, 39);
        sViewsWithIds.put(R.id.btnsave, 40);
    }
    // views
    @NonNull
    ...
    public FragmentEditPersonalProfileBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 41, sIncludes, sViewsWithIds));
    }
    private FragmentEditPersonalProfileBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
