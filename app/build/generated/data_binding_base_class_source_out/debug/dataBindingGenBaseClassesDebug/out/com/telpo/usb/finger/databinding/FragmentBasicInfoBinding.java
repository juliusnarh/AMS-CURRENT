...
public abstract class FragmentBasicInfoBinding extends ViewDataBinding {
  ...
  protected FragmentBasicInfoBinding(DataBindingComponent _bindingComponent, View _root,
      ...
      TextInputEditText country, TextInputEditText district, TextInputLayout districtLayout,
      TextInputEditText edu, TextInputLayout eduLayout, TextInputEditText email,
      TextInputLayout emailLayout, TextInputEditText farmcomm, TextInputLayout farmcommLayout,
      TextInputEditText gender, TextInputLayout genderLayout, TextInputEditText hometown,
      TextInputLayout hometownLayout, TextInputLayout idnumLayout, TextInputEditText idtype,
      TextInputLayout idtypeLayout, TextInputLayout maritalstatLayout,
      ...
      TextInputEditText txtidnum, TextView txtpinfo, TextInputEditText txtsurname) {
  ...
  public static FragmentBasicInfoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return DataBindingUtil.<FragmentBasicInfoBinding>inflate(inflater, com.telpo.usb.finger.R.layout.fragment_basic_info, root, attachToRoot, component);
  }
  ...
  public static FragmentBasicInfoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return DataBindingUtil.<FragmentBasicInfoBinding>inflate(inflater, com.telpo.usb.finger.R.layout.fragment_basic_info, null, false, component);
  }
  ...
  public static FragmentBasicInfoBinding bind(@NonNull View view,
      @Nullable DataBindingComponent component) {
    return (FragmentBasicInfoBinding)bind(component, view, com.telpo.usb.finger.R.layout.fragment_basic_info);
  }
}
